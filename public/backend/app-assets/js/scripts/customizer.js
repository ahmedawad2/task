...
(function(window, document, $) {
    ...
    ************************************/
    ...
    if(menu_type == 'horizontal-menu'){
        ...
        $('#native-scroll').parentsUntil('p').attr('style','display: none !important');
        $('#bordered-navigation').parentsUntil('p').attr('style','display: none !important');
        $('#collapsible-navigation').parentsUntil('p').attr('style','display: none !important');
        $('#static-navigation').parentsUntil('p').attr('style','display: none !important');
    ...
    if(menu_type === 'vertical-overlay-menu'){
        ...
        $('#static-layout').parentsUntil('p').attr('style','display: none !important');
        $('#static-navigation').parentsUntil('p').attr('style','display: none !important');
    }
    ...
    $('#fixed-layout').on('click',function(){
        ...
        if( $(this).prop('checked') === true ){
            ...
            if( !header_navbar.hasClass('navbar-fixed-top') && horz_layout === false ){
    ...
    $('#static-layout').on('click',function(){
        if( $(this).prop('checked') === true ){
            ...
            if(horz_layout === false){
                ...
                header_navbar.removeClass('navbar-static-top').addClass('navbar-fixed-top');
            }
            if(horz_layout === true){
